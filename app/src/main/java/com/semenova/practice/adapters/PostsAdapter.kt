...
class PostsAdapter(context: Context, resource: Int, articles: List<ArticleResponse>) :
    ArrayAdapter<ArticleResponse?>(context, resource, articles) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val article: ArticleResponse = articles[position]
